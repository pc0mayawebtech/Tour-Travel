...
const PassengerDetail = ({ handlNext }: PassengerDetailProps) => {
                ...
                <div className="formOuterBox">
                  <form method="post" onSubmit={handleSubmit}>
                    ...
                    <div className="formOuterWrapper">
                      ...
                      >
                        {inputVal.error.firstname}
                      </p>
                    </div>
                    <div className="formOuterWrapper">
                      <label htmlFor="lastname" className="labelControl">
                        Last Name
                      </label>
                      <input
                        type="text"
                      ...
                      >
                        {inputVal.error.lastname}
                      </p>
                    </div>
                    <div className="formOuterWrapper">
                      <label htmlFor="mnumber" className="labelControl">
                        Mobile Number
                      </label>
                      <input
                        type="tel"
                    ...
                    <div className="formOuterWrapper mt-2">
                      <button
                        type="submit"
                        className="btn btn btn-primary p-2 d-block m-auto"
                      >
                        Continue to Payment
                      </button>
                    </div>
