    ...
    <div className="outerBoxWrapper">
      <div className="sign-box">
        ...
        <form method="post" onSubmit={handleSubmit}>
          <input type="text" name='name' placeholder="Name" value={inputVal.name} onChange={handleChange} />
          <span className='formError'>{inputVal.error.name}</span>
          <input type="email" name='email' placeholder="Email" value={inputVal.email} onChange={handleChange} />
          <span className='formError'>{inputVal.error.email}</span>
          <input type="password" name='password' maxLength={10} placeholder="Password" value={inputVal.password} onChange={handleChange} />
