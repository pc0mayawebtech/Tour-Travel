          ...
          <div className="backWrapper mb-4" key={item?.sI?.[0]?.id}>
            <div className="flightOuterWrapper">
              <div className="d-flex align-items-center gap-3 w-25">
                ...
                <span className="flightname mb-0">
              ...
              <div className="d-flex align-items-center gap-4">
                <div>
                  <p className="flightTime">
                    {new Date(item?.sI?.[0]?.dt).toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                    })}
                  </p>
                ...
                <div>
                  ...
                  >
                    <path
                      d="M0 5c0-.552.498-1 1.113-1H82v2H1.113C.498 6 0 5.552 0 5Zm82-.143V0l12.277 4.668c.046.018.094.032.142.045.927.255.693 1.287-.336 1.287H82V4.857Z"
                      fill="#B1B9CB"
                    ></path>
                  </svg>
                ...
                <div>
                  <p className="flightTime">
                    {new Date(item?.sI?.[0]?.at).toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                    })}
                  </p>
                ...
                <div>
                  <span onClick={() => handleToggle(item?.sI?.[0]?.id)}>
                    {expandedId === item?.sI?.[0]?.id ? (
                      <FaAngleDown size={22} color="cornflowerblue" />
                    ) : (
                      <IoIosArrowUp size={26} color="cornflowerblue" />
                    )}
                  </span>
                </div>
              </div>
            ...
            {expandedId === item?.sI?.[0]?.id && (
              <div>
                    ...
                    <div className="d-flex align-items-center justify-content-start">
                      ...
                      <div className="spaceLine">
                        <img
                          src={verticalImage}
                          alt="verticalImage"
                          style={{ width: "45px", height: "145px" }}
                        />
                      </div>
                      <div className="detailsData">
                        <div>
                          <p className="mb-0">{formData.flyingform}</p>
                          <p className="airportname mb-0">
                            {item?.sI?.[0]?.da?.name}
                          </p>
                        </div>
                ...
                <div className="d-flex justify-content-end">
                  <NavLink to="/stepperbar" className="selectbtn">
                    <button type="submit" className="innerSubtn">
                      Select
                    </button>
                  </NavLink>
                </div>
